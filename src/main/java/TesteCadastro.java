...
public class TesteCadastro {
	...
	public void deveInteragirComAlerttPrompt() {
		...
		Assert.assertTrue(driver.findElement(By.id("descNome")).getText().endsWith("Diógenes"));
		Assert.assertEquals("Sobrenome: Jardim", driver.findElement(By.id("descSobrenome")).getText());
